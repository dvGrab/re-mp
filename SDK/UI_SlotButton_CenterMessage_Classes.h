...
namespace CG
{
	 ...
	 * Size -> 0x003C (FullSize[0x0614] - InheritedSize[0x05D8])
	 */
	...
	public:
		...
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0600(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_YJC3[0x3];                                   // 0x0601(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_UI_SlotButton_CenterMessage(int32_t EntryPoint);
