...
namespace CG
{
	 ...
	 * Size -> 0x03E1 (FullSize[0x0671] - InheritedSize[0x0290])
	 */
	...
	public:
		...
		class FText                                                ButtonTextValue;                                         // 0x02F0(0x0018) Edit, BlueprintVisible
		class FScriptMulticastDelegate                             ButtonDispatcher;                                        // 0x0308(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		int32_t                                                    ValueToBind;                                             // 0x0318(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_UB46[0x3];                                   // 0x031D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3VRS[0x3];                                   // 0x0669(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int32_t                                                    HoldForce;                                               // 0x066C(0x0004) Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		void ButtonImageSetWithMapping(EHIDMapping mapping);
		void SetButtonImageVisibility(bool Visible);
		...
		void SetButtonTextValue(const class FText& Value, bool JustRebuild);
		...
		void ButtonDispatcher__DelegateSignature(unsigned char Interaction, int32_t BoundValue);
