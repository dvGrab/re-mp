...
namespace CG
{
	...
	void UUI_HUD_Button_TwoImage_C::SetSecondImage(class UTexture2D* Texture)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_HUD_Button_TwoImage.UI_HUD_Button_TwoImage_C.SetSecondImage");
	...
	void UUI_HUD_Button_TwoImage_C::SetSecondImageColor(const struct FLinearColor& Color)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_HUD_Button_TwoImage.UI_HUD_Button_TwoImage_C.SetSecondImageColor");
	...
	void UUI_HUD_Button_TwoImage_C::SetSecondImageAnchors(float xMin, float Xmax, float yMin, float Ymax)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_HUD_Button_TwoImage.UI_HUD_Button_TwoImage_C.SetSecondImageAnchors");
	...
	void UUI_HUD_Button_TwoImage_C::SetImageAnchors(float xMin, float Xmax, float yMin, float Ymax)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_HUD_Button_TwoImage.UI_HUD_Button_TwoImage_C.SetImageAnchors");
	...
	void UUI_HUD_Button_TwoImage_C::SetSecondImageOffsets(float xMin, float yMin, float Xmax, float Ymax)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_HUD_Button_TwoImage.UI_HUD_Button_TwoImage_C.SetSecondImageOffsets");
	 ...
	 */
	void UUI_HUD_Button_TwoImage_C::ExecuteUbergraph_UI_HUD_Button_TwoImage(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_HUD_Button_TwoImage.UI_HUD_Button_TwoImage_C.ExecuteUbergraph_UI_HUD_Button_TwoImage");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UUI_HUD_Button_TwoImage_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UUI_HUD_Button_TwoImage_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_HUD_Button_TwoImage.UI_HUD_Button_TwoImage_C");
		return ptr;
	}
