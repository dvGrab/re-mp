...
namespace CG
{
	...
	void UUI_HUDItem_Mission_GTA3_C::UpdateText()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_HUDItem_Mission_GTA3.UI_HUDItem_Mission_GTA3_C.UpdateText");
	...
	void UUI_HUDItem_Mission_GTA3_C::GetMainContentCanvasSlot(class UCanvasPanelSlot** ContentCanvasSlot)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_HUDItem_Mission_GTA3.UI_HUDItem_Mission_GTA3_C.GetMainContentCanvasSlot");
	...
	void UUI_HUDItem_Mission_GTA3_C::GetRichText(class URichTextBlock** Text)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_HUDItem_Mission_GTA3.UI_HUDItem_Mission_GTA3_C.GetRichText");
	 ...
	 */
	void UUI_HUDItem_Mission_GTA3_C::SetContentText(const class FText& Text, const struct FLinearColor& FontColorOverride)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_HUDItem_Mission_GTA3.UI_HUDItem_Mission_GTA3_C.SetContentText");
	...
	void UUI_HUDItem_Mission_GTA3_C::Tick(const struct FGeometry& MyGeometry, float InDeltaTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_HUDItem_Mission_GTA3.UI_HUDItem_Mission_GTA3_C.Tick");
	...
	void UUI_HUDItem_Mission_GTA3_C::Construct()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_HUDItem_Mission_GTA3.UI_HUDItem_Mission_GTA3_C.Construct");
	 ...
	 */
	void UUI_HUDItem_Mission_GTA3_C::ExecuteUbergraph_UI_HUDItem_Mission_GTA3(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_HUDItem_Mission_GTA3.UI_HUDItem_Mission_GTA3_C.ExecuteUbergraph_UI_HUDItem_Mission_GTA3");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UUI_HUDItem_Mission_GTA3_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UUI_HUDItem_Mission_GTA3_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_HUDItem_Mission_GTA3.UI_HUDItem_Mission_GTA3_C");
		return ptr;
	}
