...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass UI_HUDItem_Wasted_SA.UI_HUDItem_Wasted_SA_C
	 * Size -> 0x0020 (FullSize[0x0478] - InheritedSize[0x0458])
	 */
	class UUI_HUDItem_Wasted_SA_C : public UUI_HUDItem_FullScreenText_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_UI_HUDItem_Wasted_SA(int32_t EntryPoint);
