...
namespace CG
{
	...
	public:
		...
		class FScriptMulticastDelegate                             PasswordSent;                                            // 0x02C0(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		...
		unsigned char                                              UnknownData_CT46[0x6];                                   // 0x02D2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              LastSelectedWidget[0x28];                                // 0x02D8(0x0028) UNKNOWN PROPERTY: SoftObjectProperty
	...
	public:
		...
		void Cleanup(const class FString& OutPass);
		void BndEvt__ClearButton_K2Node_ComponentBoundEvent_2_ButtonDispatcher__DelegateSignature(unsigned char Interaction, int32_t BoundValue);
		void BndEvt__EnterButton_K2Node_ComponentBoundEvent_3_ButtonDispatcher__DelegateSignature(unsigned char Interaction, int32_t BoundValue);
		void IncorrectPassDialog();
		void CustomEvent_1(bool DidAccept);
		void ExecuteUbergraph_UI_PasswordDialog(int32_t EntryPoint);
		void PasswordSent__DelegateSignature(const class FString& OutPass);
