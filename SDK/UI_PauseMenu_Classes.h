...
namespace CG
{
	 ...
	 * Size -> 0x01AD (FullSize[0x05A5] - InheritedSize[0x03F8])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_8CSD[0x3];                                   // 0x0579(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CQ9X[0x3];                                   // 0x058D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_M0TC[0x3];                                   // 0x0595(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void SetupButtonMappingWithImage(EHIDMapping mapping, class UMenuHelpText_Template_C* HelpTextObject, ESlateVisibility* NewVisiblity);
