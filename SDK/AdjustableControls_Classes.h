...
namespace CG
{
	 ...
	 * Size -> 0x0740 (FullSize[0x09D0] - InheritedSize[0x0290])
	 */
	...
	public:
		...
		TArray<class FText>                                        SlotTitles;                                              // 0x0520(0x0010) Edit, BlueprintVisible, DisableEditOnInstance
		...
		class FText                                                RestoreControlsMessage;                                  // 0x08B0(0x0018) Edit, BlueprintVisible, DisableEditOnInstance
		...
		EGTAInputType                                              LastInputType;                                           // 0x08F8(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_EX5N[0x3];                                   // 0x08F9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int32_t                                                    CurrentSelectedControllerMode;                           // 0x08FC(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void UpdateUI(EGTAInputType CurrentInput);
		void GetControllerNavigationWidgets(int32_t ArrayIndex, TArray<class UWidget*>* Array, bool IsLeft, TArray<class UWidget*>* OtherArray, class UWidget** Up, class UWidget** Down, class UWidget** Left, class UWidget** Right);
		...
		void AdjustButtonPressed(unsigned char InteractionType, int32_t BoundValue, class UUI_SlotButton_C* SlotButton);
		void Show_Window(EGTAInputType CurrentTypeToShow);
		void SetupForKeyboard();
		EGTAInputType GetInputType();
		void SetupRightSlots();
		void CreateMappingSlot(const class FText& Main_Text, const class FText& Alt_Text, int32_t Index, class UUI_ScrollingSlotList_C* ListToAddTo, bool IsLeftPanel, int32_t BoundMapping);
		void SetupLeftSlots();
		void SetupSlotTitles();
		void UpdateButtons();
		void UpdateSlotStyle();
		void Construct();
		void BndEvt__ResetButton_K2Node_ComponentBoundEvent_1_ButtonDispatcher__DelegateSignature(unsigned char Interaction, int32_t BoundValue);
		void ForceButtonsHovered();
		void ForceButtonsNormal();
		void ForceButtonsSelected();
		void PreConstruct(bool IsDesignTime);
		void BndEvt__ControllerTemplateSelect_K2Node_ComponentBoundEvent_3_DidUpdateSettings__DelegateSignature(bool RequiresOptionRefresh, const class FName& PropertyNameToSelect);
		void Tick(const struct FGeometry& MyGeometry, float InDeltaTime);
		void ExecuteUbergraph_AdjustableControls(int32_t EntryPoint);
