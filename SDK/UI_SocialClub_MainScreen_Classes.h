...
namespace CG
{
	...
	public:
		...
		TArray<class FText>                                        ButtonText;                                              // 0x0318(0x0010) Edit, BlueprintVisible
		...
		unsigned char                                              UnknownData_DA9U[0x6];                                   // 0x032A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class FString>                                      ButtonFunction;                                          // 0x0330(0x0010) Edit, BlueprintVisible
		int32_t                                                    LastSelectedWidgetIndex;                                 // 0x0340(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_CL9E[0x3];                                   // 0x0345(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_33F9[0x7];                                   // 0x0359(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              ParentSocialClub[0x28];                                  // 0x0360(0x0028) UNKNOWN PROPERTY: SoftObjectProperty
	...
	public:
		...
		void ExecuteUbergraph_UI_SocialClub_MainScreen(int32_t EntryPoint);
