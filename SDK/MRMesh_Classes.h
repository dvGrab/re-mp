...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_CR4Z[0x4];                                   // 0x020C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XARG[0x4];                                   // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5BSP[0x20];                                  // 0x0250(0x0020) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x00B8 (FullSize[0x0500] - InheritedSize[0x0448])
	 */
	class UMRMeshComponent : public UPrimitiveComponent
	{
	public:
		unsigned char                                              UnknownData_FU1X[0x8];                                   // 0x0448(0x0008) Fix Super Size
		unsigned char                                              UnknownData_42TM[0x8];                                   // 0x0450(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_H9HI[0x5];                                   // 0x046B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_832G[0x78];                                  // 0x0488(0x0078) MISSED OFFSET (PADDING)
