...
namespace CG
{
	...
	public:
		...
		int32_t                                                    MenuButtonOffset;                                        // 0x02B8(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		EGTASaveTabState                                           CurrentSaveTabState;                                     // 0x02BC(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_FRKU[0x3];                                   // 0x02BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int32_t                                                    CurrentSaveIndexSelected;                                // 0x02C0(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_58YI[0x4];                                   // 0x02C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              LastUserSelectedWidget[0x28];                            // 0x02C8(0x0028) UNKNOWN PROPERTY: SoftObjectProperty
		...
		unsigned char                                              UnknownData_2AIG[0x3];                                   // 0x0305(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              PlayInteractSound[0x28];                                 // 0x0308(0x0028) UNKNOWN PROPERTY: SoftObjectProperty
		...
		int32_t                                                    DelayedGameLaunchSaveSlot;                               // 0x0360(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		EGTASaveTabState                                           SaveTabState;                                            // 0x0367(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_5KND[0x6];                                   // 0x036A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class FText                                                BrowserConfirmationDialog;                               // 0x03A0(0x0018) Edit, BlueprintVisible, DisableEditOnInstance
		int32_t                                                    LastLeftButtonSelected;                                  // 0x03B8(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_ZUOZ[0x4];                                   // 0x03BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QAXG[0x5];                                   // 0x03CB(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_A9X7[0x3];                                   // 0x03F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int32_t                                                    LastClickedButtonIndex;                                  // 0x03F4(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void CreateNewControllerDialog(const class FText& DialogText);
		...
		void UpdateUserInfo(const class FString& UserName, class UTexture2D* UserImage);
		...
		void CreateNewOkDialog(const class FText& DialogText);
		...
		void RefreshAllOptions(bool KeepPreviousOption);
		...
		void DelayedStartGame(int32_t ForSaveSlot);
		void CallSelectedOnActiveTab();
		void SetActiveWidget(int32_t Index);
		void LanguageUpdatedTasks();
		void HandleMapBack(bool* DidHandle);
		void EndMapInteract();
		void StartMapInteract();
		void GetLeftButtonOverrideImage(class UGTAMainMenuUITemplate* Template, int32_t Index, class UTexture2D** Output);
		...
		void Set_to_SaveTab(EGTASaveTabState toState, int32_t* IndexInWidgetSelector);
		void DoTabSpecial(int32_t TabNum);
		void MoveToTabNum(int32_t ToTab);
		...
		void GetNavigationButtonsForEntry(TArray<class UWidget*>* Array, int32_t EntryNum, class UUI_Button_Base_C** Up, class UUI_Button_Base_C** Down);
		...
		void UpdateButtonsOnInteract(EButtonStateEnum InteractButton, int32_t BoundValue);
		void SetCurrentSaveTabState(EGTASaveTabState NewSaveTabState, class UUI_TabbedLayout_C* FromTabbedLayout);
		void GetSavesTab(class UUI_OptionsMenuTab_Game_C** OutSavesTab, int32_t* IndexInWidgetSelector);
		void InteractedSaveStateButtonPressed(int32_t SaveNumber, class UUI_TabbedLayout_C* FromTabbedLayout);
		void Refresh_Saves();
		...
		void AddEmptyTab();
		void CreateMainBaseButtonFromClass(class UClass* ButtonClass, const class FText& ButtonText, int32_t ValueToBind, class UTexture2D* SelectedImageOverride, class UUI_Button_Base_C** OutButton);
		void InteractedButton(unsigned char InteractionType, int32_t BoundValue);
		...
		void ExecuteUbergraph_UI_Menu_Base_BP(int32_t EntryPoint);
