...
namespace CG
{
	 ...
	 * Size -> 0x0530 (FullSize[0x0B08] - InheritedSize[0x05D8])
	 */
	...
	public:
		...
		void InteractedWithSliderSlot(unsigned char InteractionType, int32_t BoundValue, class UUI_SlotButton_C* SlotButton);
		...
		void ExecuteUbergraph_UI_SlotButton_Slider(int32_t EntryPoint);
