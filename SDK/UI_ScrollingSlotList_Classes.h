...
namespace CG
{
	 ...
	 * Size -> 0x0278 (FullSize[0x0508] - InheritedSize[0x0290])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_H9M6[0x7];                                   // 0x02B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              ParentTabbedLayout[0x28];                                // 0x02B8(0x0028) UNKNOWN PROPERTY: SoftObjectProperty
		...
		unsigned char                                              UnknownData_WU0X[0x7];                                   // 0x0439(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              LastUserSelectedWidget[0x28];                            // 0x0440(0x0028) UNKNOWN PROPERTY: SoftObjectProperty
		...
		int32_t                                                    OverrideSlotFocus;                                       // 0x04B0(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_N4E3[0x3];                                   // 0x04B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptMulticastDelegate                             OnSelectedTab;                                           // 0x04B8(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		class FScriptMulticastDelegate                             OnDeselectedTab;                                         // 0x04C8(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		...
		unsigned char                                              UnknownData_2QBJ[0x2];                                   // 0x04DA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		ESlateVisibility                                           ScrollBarVisibility;                                     // 0x04E0(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_XHI6[0x7];                                   // 0x04E1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FText                                                VersionString;                                           // 0x04E8(0x0018) Edit, BlueprintVisible, DisableEditOnInstance
	...
	public:
		void OnOptionPressed(class UUI_SlotButton_C* PressedButton);
		void SetVersionText();
		...
		void FocusSpecificSlot(int32_t SlotIndex, bool* WasValid, class UUI_SlotButton_C** SelectedSlotButton);
		void GrabSpecificOptionFocus(const class FName& PropertyName, class UWidget** FocusedWidget);
		void ClearSlotList();
		void SetFocusToFirstEntry();
		void SetupNavigation();
		void Grab_Slot_Focus(bool ForceIgnoreSound, class UUI_SlotButton_C** SelectedSlotButton);
		void UpdateFocus();
		void UpdateSelectedSlot(class UUI_SlotButton_C* SelectedItem, bool FromHover);
		void SetMenu();
		...
		void SlotButtonPressed(unsigned char InteractionType, int32_t BoundValue, class UUI_SlotButton_C* ButtonSentFrom);
		void ExecuteUbergraph_UI_ScrollingSlotList(int32_t EntryPoint);
