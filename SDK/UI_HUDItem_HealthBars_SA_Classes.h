...
namespace CG
{
	 ...
	 * Size -> 0x00DC (FullSize[0x0518] - InheritedSize[0x043C])
	 */
	class UUI_HUDItem_HealthBars_SA_C : public UUI_HUDItem_Base_C
	{
	public:
		unsigned char                                              UnknownData_TWO9[0x4];                                   // 0x043C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TF08[0x7];                                   // 0x04C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SSJI[0x4];                                   // 0x04F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UClass*                                              BarClass;                                                // 0x04F8(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class FText                                                TestString2;                                             // 0x0500(0x0018) Edit, BlueprintVisible

	public:
		void UpdateBars(const class FString& FunctionName, TArray<float>* Array);
		void AlignText(const class FString& AlignName);
		void CreateNewVerticalEntry();
		void UpdateStrings(const class FString& Selection, TArray<class FString> TargetArray);
		void SetElementNum(int32_t NumItems);
		...
		void ExecuteUbergraph_UI_HUDItem_HealthBars_SA(int32_t EntryPoint);
