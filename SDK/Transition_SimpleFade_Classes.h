...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass Transition_SimpleFade.Transition_SimpleFade_C
	 * Size -> 0x005A (FullSize[0x0320] - InheritedSize[0x02C6])
	 */
	class UTransition_SimpleFade_C : public UTransition_Base_C
	{
	public:
		unsigned char                                              UnknownData_YK92[0x2];                                   // 0x02C6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Transition_SimpleFade(int32_t EntryPoint);
