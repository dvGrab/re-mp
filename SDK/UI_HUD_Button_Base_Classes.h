...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_5W9F[0x4];                                   // 0x043C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_UI_HUD_Button_Base(int32_t EntryPoint);
