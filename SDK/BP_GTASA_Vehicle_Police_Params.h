...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_GTASA_Vehicle_Police.BP_GTASA_Vehicle_Police_C.GetSpecialLightMaterial
	 */
	struct ABP_GTASA_Vehicle_Police_C_GetSpecialLightMaterial_Params
	{
	public:
		int32_t                                                    Index;                                                   // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_FV0Q[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_GTASA_Vehicle_Police.BP_GTASA_Vehicle_Police_C.GetSirenClass
	 */
	struct ABP_GTASA_Vehicle_Police_C_GetSirenClass_Params
	{
	public:
		bool                                                       Left;                                                    // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_ZF5Y[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
