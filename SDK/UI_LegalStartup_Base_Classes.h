...
namespace CG
{
	 ...
	 * Size -> 0x00BF (FullSize[0x034F] - InheritedSize[0x0290])
	 */
	...
	public:
		...
		int32_t                                                    CurrentScreenNum;                                        // 0x0300(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_1JWO[0x4];                                   // 0x0304(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CDG8[0x7];                                   // 0x0331(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_UI_LegalStartup_Base(int32_t EntryPoint);
