...
namespace CG
{
	...
	void UMenuHelpText_Template_C::UpdateText()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function MenuHelpText_Template.MenuHelpText_Template_C.UpdateText");
	 ...
	 */
	void UMenuHelpText_Template_C::Set_Button_Image_FromMapping(class UGameterface* Gameterface, EHIDMapping mapping, bool* FoundImage)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function MenuHelpText_Template.MenuHelpText_Template_C.Set Button Image FromMapping");
	...
	void UMenuHelpText_Template_C::Set_Button_Image_With_UVs(class UTexture2D* InTexture, float U, float V, float ULength, float VLength)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function MenuHelpText_Template.MenuHelpText_Template_C.Set Button Image With UVs");
	...
	void UMenuHelpText_Template_C::GetButton(class UButton** Button)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function MenuHelpText_Template.MenuHelpText_Template_C.GetButton");
	...
	void UMenuHelpText_Template_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function MenuHelpText_Template.MenuHelpText_Template_C.PreConstruct");
	...
	void UMenuHelpText_Template_C::Construct()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function MenuHelpText_Template.MenuHelpText_Template_C.Construct");
	 ...
	 */
	void UMenuHelpText_Template_C::ExecuteUbergraph_MenuHelpText_Template(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function MenuHelpText_Template.MenuHelpText_Template_C.ExecuteUbergraph_MenuHelpText_Template");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UMenuHelpText_Template_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UMenuHelpText_Template_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass MenuHelpText_Template.MenuHelpText_Template_C");
		return ptr;
	}
