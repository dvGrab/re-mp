...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_GYIF[0x2];                                   // 0x0C46(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_UI_ConfirmationDialog_FullScreen(int32_t EntryPoint);
