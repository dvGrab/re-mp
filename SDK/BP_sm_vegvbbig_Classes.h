...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_sm_vegvbbig.BP_sm_vegvbbig_C
	 * Size -> 0x0020 (FullSize[0x02E8] - InheritedSize[0x02C8])
	 */
	class ABP_sm_vegvbbig_C : public ABP_TreeBase_C
	{
	public:
		...
		class UStaticMeshComponent*                                SM_Prop_Tree_Oak_01;                                     // 0x02E0(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
