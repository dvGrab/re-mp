...
namespace CG
{
	...
	public:
		...
		TMap<class FName, class UClass*>                           HUDItemTemplates;                                        // 0x02C8(0x0050) Edit, BlueprintVisible, DisableEditOnInstance
		TMap<class FName, class UUI_GTAHUDItem*>                   HUDItems;                                                // 0x0318(0x0050) Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference
		bool                                                       CreateAllItemsAtStart;                                   // 0x0368(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_EZD5[0x3];                                   // 0x0369(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void AddNewItemToCanvas(class UUI_GTAHUDItem* Item, const class FName& UnderName);
		void CreateAllHudItems();
		void CreateHudItem(const class FName& For, class UUI_GTAHUDItem** OutItem);
		...
		void ExecuteUbergraph_HUDDrawer_Base(int32_t EntryPoint);
