...
namespace CG
{
	...
	void UUI_ConfirmationDialog_FullScreen_C::Tick(const struct FGeometry& MyGeometry, float InDeltaTime)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_ConfirmationDialog_FullScreen.UI_ConfirmationDialog_FullScreen_C.Tick");
	...
	void UUI_ConfirmationDialog_FullScreen_C::Construct()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_ConfirmationDialog_FullScreen.UI_ConfirmationDialog_FullScreen_C.Construct");
	...
	void UUI_ConfirmationDialog_FullScreen_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_ConfirmationDialog_FullScreen.UI_ConfirmationDialog_FullScreen_C.PreConstruct");
	 ...
	 */
	void UUI_ConfirmationDialog_FullScreen_C::ExecuteUbergraph_UI_ConfirmationDialog_FullScreen(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_ConfirmationDialog_FullScreen.UI_ConfirmationDialog_FullScreen_C.ExecuteUbergraph_UI_ConfirmationDialog_FullScreen");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UUI_ConfirmationDialog_FullScreen_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UUI_ConfirmationDialog_FullScreen_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_ConfirmationDialog_FullScreen.UI_ConfirmationDialog_FullScreen_C");
		return ptr;
	}
