...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_FK0U[0x1B];                                  // 0x0065(0x001B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SDJB[0x3];                                   // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_T37U[0x4];                                   // 0x008C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_003J[0x7];                                   // 0x0059(0x0007) MISSED OFFSET (PADDING)
