...
namespace CG
{
	 ...
	 * Size -> 0x04D8 (FullSize[0x0768] - InheritedSize[0x0290])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_MLEB[0x7];                                   // 0x0469(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_HACN[0x2];                                   // 0x070E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J7OR[0x4];                                   // 0x0714(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		class UWidget* Scroll(EUINavigation Navigation);
		bool TakeFocus();
		...
		void ExecuteUbergraph_UI_Brief(int32_t EntryPoint);
