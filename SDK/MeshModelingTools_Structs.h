...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_BXWG[0xC];                                   // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_30O8[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FTransform                                          Transform;                                               // 0x0010(0x0030) Edit, EditConst, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		struct FKShapeElem                                         Element;                                                 // 0x0040(0x0030) Edit, EditConst, NativeAccessSpecifierPublic
	};
	...
	public:
		...
		unsigned char                                              UnknownData_86KK[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FTransform                                          Transform;                                               // 0x0010(0x0030) Edit, EditConst, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		struct FKShapeElem                                         Element;                                                 // 0x0040(0x0030) Edit, EditConst, NativeAccessSpecifierPublic
	};
